    ...
    <>
      ...
      <div className="flex min-[900px]:hidden flex-col  items-center h-[75vh] gap-20 my-5 max-[900px]:my-10 mx-10">
        ...
        <div>
          ...
          <p className="text-[#474444] w-[100%]  ">
            "Embark on your journey of knowledge with our comprehensive range of
            courses, designed for learners of all levels. Discover, learn, and
            grow with ease on our platform."
          </p>
          {useAuth.isLoggedIn && useAuth.user ? (
            <button
              onClick={() => navigate("/courses")}
              className="p-2 bg-[#846446] text-white mt-4 w-2/4 text-2xl rounded-lg"
            >
              Explore courses
            </button>
          ) : (
