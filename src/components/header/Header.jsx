        ...
        <div className="m-2 mt-6 ">
          {!useAuth.isLoggedIn ? (
            <div className="flex gap-6 mr-10 max-[600px]:mr-0">
              <Link
                to="/login"
                className="text-xl max-[600px]:text-lg  hover:bg-[#846446] hover:text-white px-5 py-1.5 rounded-xl"
              >
                {" "}
                Login/Signup{" "}
              </Link>
            ...
            <>
              <div className="max-[800px]:hidden">
                <button
                  className="text-xl  hover:bg-[#846446] hover:text-white px-5 py-1.5 rounded-xl"
                ...
                <button
                  className="hover:bg-[#846446] hover:text-white px-5 py-1.5 rounded-xl text-xl relative"
                ...
                {showMenuOpt && (
                  <div
                    className="absolute cursor-pointer text-lg text-black right-5 z-10 top-20 w-[200px] p-2 bg-white border border-black"
                    onClick={() => {
                      navigate(
                        useAuth.user.isInstructor
                          ? "/uploadCourse"
                          : "/beInstructor"
                      );
                ...
                <button
                  className="relative bg-[#846446] font-semibold text-white rounded-full w-fit py-2.5 px-5 mx-2   h-fit"
                  onClick={() => {
                    navigate("/profile");
                    setMenuOpen(false);
                  }}
              ...
              {menuopen && (
                <div className="min-[800px]:hidden z-50 absolute bg-white h-[100vh] w-[60%] text-2xl  flex flex-col mt-10 right-2 gap-10  items-center">
                  <button
                    className="bg-[#846446] font-semibold text-white rounded-full w-fit py-2.5 px-5 mx-2   h-fit"
                    onClick={() => {
                      navigate("/profile");
                      setMenuOpen(false);
                    }}
                  ...
                  <button
                    className="hover:bg-[#846446] hover:text-white px-5 py-1.5 rounded-xl"
                    onClick={() => {
                      navigate("/mycourses");
                      setMenuOpen(false);
                    }}
